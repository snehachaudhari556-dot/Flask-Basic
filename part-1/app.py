...
def home():
    return "<h1>Hello Sneha!</h1><p>Welcome to my first Flask web server.</p>"  # This text displays in the browser


@app.route('/about')
def about():
    return "<h2>About Page</h2><p>This is the about page of my Flask application.</p>"
